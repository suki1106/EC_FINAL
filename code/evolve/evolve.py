...
def evolve():
    ...
    creator.create("FitnessMax", base.Fitness, weights=optimization_weights) #define fitness class, its a maximizing problem 
    creator.create("Individual", list, fitness=creator.FitnessMax) #define individual is using list, and a fitness for an individual
    toolbox = base.Toolbox()
    toolbox.register("attr_bool", random.randint, 0, 1) #attr_bool is an func to randomly initial the chromosome by using randint
    toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.attr_bool, gene_len) #individual generated by using 
